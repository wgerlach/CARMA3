...
> ./autogen.sh
# if autogen.sh fails, maybe you need new macro files (m4_ax_boost*.m4 in CARMA directory) for the BOOST library,
#     they can be found here: http://www.gnu.org/software/autoconf-archive/The-Macros.html
